#ifndef TESTDEFORMINGCRYPTPITHELIUMWITHALTERNATINGTCREGIONS_HPP_
#define TESTDEFORMINGCRYPTPITHELIUMWITHALTERNATINGTCREGIONS_HPP_
...
#include "BasementMembraneForceWithAlternatingTc.hpp" //BM force (based off Dunn et al. (2012))
...
static const std::string M_SS_OUTPUT_DIRECTORY = M_OUTPUT_DIRECTORY + "/ALTERNATINGTC/";
...
class TestDeformingEpitheliumWithAlternatingTCRegions : public AbstractCellBasedTestSuite
{
public:
	void TestCryptDeformation()
	{
		...
		double target_curvature = 0.5;
		unsigned num_alternating_regions = 2; 
        ...
        out << "B_" << bm_stiffness << "_TC_" << target_curvature << "_N_" << num_alternating_regions;
        std::string output_directory = M_SS_OUTPUT_DIRECTORY + out.str();
		...
		MAKE_PTR(BasementMembraneForceWithAlternatingTc, p_bm_force);
        ...
        p_bm_force->SetNumberAlternatingRegions(num_alternating_regions);
...
#endif /* TESTDEFORMINGCRYPTPITHELIUMWITHALTERNATINGTCREGIONS_HPP_ */
