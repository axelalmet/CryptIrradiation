...
private:
    ...
    /**
     * Non-dimensionalized Wnt stem threshold, above which stem cells differentiate into transit-amplifying cells if not quiescent.
     */
