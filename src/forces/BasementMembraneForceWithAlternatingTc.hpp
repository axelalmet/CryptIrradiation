#ifndef BasementMembraneForceWithAlternatingTc_HPP_
#define BasementMembraneForceWithAlternatingTc_HPP_
...
class BasementMembraneForceWithAlternatingTc : public AbstractForce<2>
{
...
private :
    ...
    /* Specify the number of alternating regions of +/- TC */
    unsigned mNumberAlternatingRegions;
    ...
    void serialize(Archive & archive, const unsigned int version)
    {
        ...
        archive & mNumberAlternatingRegions;
...
public :
    ...
    /* Number of alternating TC regions in layer */
    void SetNumberAlternatingRegions(unsigned numberAlternatingRegions);

    /* Get method for number of alternating regions
     */
    unsigned GetNumberAlternatingRegions();
    ...
    /* Returns crypt width extremes to determine how to apply +/- TC*/
...
#endif /*BasementMembraneForceWithAlternatingTc_HPP_*/
